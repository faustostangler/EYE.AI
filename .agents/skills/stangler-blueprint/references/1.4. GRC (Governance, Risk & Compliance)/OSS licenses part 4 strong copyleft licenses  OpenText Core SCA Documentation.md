---
name: OSS licenses part 4: strong copyleft licenses | OpenText Core SCA Documentation
keywords: (placeholder)
metadata:
  url: https://docs.debricked.com/opentext-core-sca-blogs/blogs/oss-licenses-part-4-strong-copyleft-licenses
  source: SOURCE_TYPE_WEB_PAGE
  date: 2026-05-14T23:03:23.186Z
  notebook: 1.4. GRC (Governance, Risk & Compliance)
---
OSS licenses part 4: strong copyleft licenses | OpenText Core SCA Documentation 
...
Learn about strong copyleft licenses.
...
The AGPL license
Another common strong copyleft license is the GNU Affero General Public License . In the GPLv3 license, to convey a program explicitly means that you enable other parties to make or receive copies. If they cannot do that, then you are not conveying. If you are not conveying, then the obligations in the GPLv3 license do not apply.
...
Accept Reject  
What are the first steps to get started with OpenText Core SCA?
How do I authenticate API requests to OpenText Core SCA?
Which components are included in vulnerability management, like data sources and PRs?
How can you migrate from Legacy CLI to OpenText Core SCA CLI?
Where can you access the OpenText Core SCA APIs and docs?    
/ esc  
Navigate esc
Close 
...
OpenText CORE SCA BLOGS
Blogs
Copyright and open-source licenses part1: what is copyright?
