---
name: DORA's software delivery performance metrics
...
These metrics have evolved alongside the technology landscape: shifting from the original four keys to the current five-metric model. To understand the research behind changes like the move from MTTR to Failed Deployment Recovery Time, read A history of DORA's software delivery metrics.
...
Throughput and instability link click to copy link
...
Throughput link click to copy link
...
Instability link click to copy link
...
Key insights link click to copy link
...
Common pitfalls link click to copy link
...
Dive into the research link click to copy link
...
Next steps link click to copy link
...
Resources FAQ Contact Us
DORA is a program run by Google Cloud. All content on this site is licensed by Google LLC under CC BY-NC-SA 4.0, unless otherwise specified.
post_linkedin post_youtube github
