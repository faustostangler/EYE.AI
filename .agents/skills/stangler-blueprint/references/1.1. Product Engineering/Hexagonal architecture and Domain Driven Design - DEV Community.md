---
name: Hexagonal architecture and Domain Driven Design - DEV Community
...
---
Hexagonal architecture and Domain Driven Design - DEV Community
Skip to content
Powered by Algolia
Log in Create account
DEV Community
29 Add reaction 
27 Like  2 Unicorn  0 Exploding Head  0 Raised Hands  0 Fire
0 Jump to Comments 24 Save Boost
Copy link
Copied to Clipboard
Share to X Share to LinkedIn Share to Facebook Share to Mastodon
Report Abuse
 
Kevin Dupeyrat for Onepoint
...
Let's stay in touch. LinkedIn | Medium
 The DEV Team
Promoted
What's a billboard?
Manage preferences
...
Beyond the Obvious
More from Onepoint
Generating an aerial view of your project with OpenRewrite # java # jreleaser # openrewrite # graph
Quelle est la taille idéale d'une classe ? # adventoftech2025 # maintainability # cleancode # java
Release everything with JReleaser # java # jreleaser # maven
 AWS
Promoted
What's a billboard?
Manage preferences
