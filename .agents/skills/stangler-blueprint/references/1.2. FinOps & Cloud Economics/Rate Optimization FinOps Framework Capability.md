---
name: Rate Optimization FinOps Framework Capability
...
---
Rate Optimization FinOps Framework Capability
...
Rate Optimization
Framework / Domains / Optimize Usage & Cost / Rate Optimization
On this page
Definition
Maturity Assessment
...
](https://www.finops.org/wg/applying-the-finops-framework-to-saas/)
...
The percentage of commitments not applied to on-demand spend.
Formula
(Cost of Commitment Discount unused / total cost Commitment Discount) x 100
Data Sources:
CSP Billing Data
Related Capabilities
Rate Optimization
...
Rate optimization recommendations
View former Managing Commitment Based Discounts page
On this page
Definition
Maturity Assessment
Functional Activities
...
Inputs & Outputs
Related Assets
Commitment Discounts Overview Cloud Service Provider Commitment Discounts Offerings Matrix How to Use a "Green/Red" Approach to RI Buying Advanced Approach to Prepay Amortization and Rate Blending (Intuit) Centralizing Prepaid Cloud Discount Reservations (Koch Industries) How to Decipher Azure Amortized Cost (Shell) Effective Savings Rate (ESR): The Ultimate FinOps Rate Optimization Metric
Follow Us:
